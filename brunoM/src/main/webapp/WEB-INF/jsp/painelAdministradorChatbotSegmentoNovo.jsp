	...
	<main class="bl-corpo">
		<div class="container">
			<article>
				...
				<form class="bl-corpo-formulario" name="" action="${contextPath}/painelAdmin/segmentoNovo" method="POST">
					<label>Crie um nome:</label>
					<input type="text" name="nome" value="	" />					
					
					<label>Escolha um bot para ser responsável:</label>
					...
					<button type="submit" class="btn-edita">Criar novo segmento</button>
				</form>
			</article>
		</div>
	</main>
